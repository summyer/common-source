...
class Buy_Tickets(object):
    ...
    def __init__(self, username, passwd, order, passengers, dtime, starts, ends):
        ...
        self.executable_path = 'D:\chromedriver_win32\chromedriver.exe'
    # 登录功能实现
    def login(self):
...
if __name__ == '__main__':
    ...
    ticket=Buy_Tickets(username, password, order, passengers, dtime, starts, ends)
    #ticket.before()
    #ticket.login()
    #ticket.start_buy()
    print('襄阳'.encode('utf-8'))
